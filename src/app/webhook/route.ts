...
// Generic webhook endpoint (singular "webhook")
export async function POST(request: NextRequest) {
  console.log('Received webhook at /webhook - forwarding to /api/webhooks/netbanx');
  ...
  try {
    ...
    console.error('Error forwarding webhook from /webhook:', error);
